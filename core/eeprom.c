...
eeprom_init (void)
{
...
#ifdef AQUALOOP_SUPPORT
  aqualoop_params_t aqualoop_temp = {

    .MEM_number = AQUALOOP_NUMBER_MEMBRANES,

    .suction_overflow = AQUALOOP_SO,

    .sludge_pump_weeks = AQUALOOP_SLPW,
    .sludge_pump_days = AQUALOOP_SLPD,
    .sludge_pump_minutes = AQUALOOP_SLPM,

    .suction_c1 = AQUALOOP_C1,
    .suction_c2 = AQUALOOP_C2,

    .air_on = AQUALOOP_AIRON,
    .air_off = AQUALOOP_AIROFF,

    .t1_hour = AQUALOOP_T1H,
    .t1_min = AQUALOOP_T1M,

    .t2_hour = AQUALOOP_T2H,
    .t2_min = AQUALOOP_T2M,
  ...
  eeprom_save (aqualoop_params, &aqualoop_temp, sizeof(aqualoop_params_t));
#endif

#ifdef RAINMASTER_SUPPORT
  rainmaster_params_t rainmaster_temp = {
