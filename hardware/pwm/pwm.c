...
void pwm_init(){
  ...
  //TCCR1B|=_BV(CS10); 		// 24 khz @ 6,144 Mhz	// clockselect: clkI/O/1 (No prescaling)
  TCCR1B|=_BV(CS11); 		//  3 khz		// clockselect: clkI/O/8 (From prescaler)
