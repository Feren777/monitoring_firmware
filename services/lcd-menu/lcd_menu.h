 ...
 */
#define MENU_ITEM(name, next, parent, child, next_func, enter_func, display_func, text) \
	...
	menu_item_t MENU_ITEM_STORAGE name = {&next, &parent, &child, next_func, enter_func, display_func, text}
